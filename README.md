...
蔚蓝点名 NEXT版本基于 **.NET 10 (C# / WPF) + WebView2 (Vue 3 + Vite)** 重构的现代化桌面随机点名工具，灵感来源于 **《蔚蓝档案(Blue Archive)》** 的学生招募动画。悬浮按钮常驻桌面，一键触发抽取动画，有趣的招募动画为枯燥的课堂教学添加乐趣。
...
- **本项目已全面用C#重构，架构进行了大幅度调整，难免有许多不完善之处，欢迎指正与贡献改进。**
- **本项目采用了部分第三方美术资源，项目作者并没有获得授权，如造成侵权请联系删除。**
- **作者刚入手C#开发，除自己规划架构外大部分代码靠AI实现，如有问题欢迎批评指正**
